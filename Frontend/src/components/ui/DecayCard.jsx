...
const DecayCard = ({
  ...
  return (
    <div className="content rounded-3xl overflow-hidden shadow-2xl" style={{ width: typeof width === 'number' ? `${width}px` : width, height: typeof height === 'number' ? `${height}px` : height }} ref={svgRef}>
