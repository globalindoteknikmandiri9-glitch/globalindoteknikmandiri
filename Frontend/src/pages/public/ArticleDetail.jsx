...
import { Calendar, Clock, ChevronRightIcon, BookOpen, Facebook, Twitter, Link as LinkIcon, Share2, ChevronLeft, ChevronRight } from "lucide-react"
        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:bg-sky-50 hover:text-sky-500 hover:border-sky-200 transition-colors">
